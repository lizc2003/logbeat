...
require (
	...
	github.com/elastic/beats/v7 v7.0.0
)
...
require (
	...
	github.com/elastic/elastic-agent-autodiscover v0.6.2 // indirect
	github.com/elastic/elastic-agent-client/v7 v7.3.0 // indirect
...
replace (
	...
	github.com/elastic/beats/v7 => ../elastic-beats
